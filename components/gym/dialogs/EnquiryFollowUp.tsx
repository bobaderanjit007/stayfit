...
import { EnquiryFollowUpState } from "@/app/(main)/gym/enquiry/page";
...
type EnquiryFollowUpProps = {
  enquiryFollowUp: EnquiryFollowUpState;
...
const EnquiryFollowUp = ({
  ...
  return (
    ...
    >
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Follow Up For Enquiry</DialogTitle>
        </DialogHeader>
        {/* Add Plan Form  */}
